...
export const ArtCard = ({ artist, title, medium, price, src }) => {
  return (
    <div className="flex w-[350px] min-w-[240px] flex-col items-start overflow-hidden bg-gray-200 px-5 py-6">
      <Image
        loading="lazy"
        src={src}
        alt={`Artwork ${title} by ${artist}`}
        className="aspect-[0.73] w-full self-stretch object-contain"
      />
      ...
      <div className="mt-8 text-2xl text-neutral-500">{price} uan</div>
      <button
